    ...
    <div id="State">
      <div className="headerContainer">
        <Breadcrumb style={{fontSize:"1.1rem"}}>
          ...
          <BreadcrumbItem active>{stateName}</BreadcrumbItem>
        </Breadcrumb>
        <hr />
      </div>
      <div className="pageContainer">
...
class NavAndPanesAndVotingCard extends React.Component {
  ...
  componentWillMount() {
    this.setState({activeTab: stateInfo[this.props.stateId].legislatures[0].id})
  }
  ...
  render() {
      ...
      <TabPane key={x.id + "tabpane"} tabId={x.id}>
        {x.districts.map(y => (
          ...
          <div key={y.name + "district"}>
            <div className="districtNameInTabs" style={{marginBottom:10}}>
              {x.name} – {y.name}
            </div>
            <div className="">
              <ButtonGroup>
    ...
    return (
      <Row id="NavAndPanesAndVotingCard">
        <Col id="leftColumn" sm="7">
          <h5>Candidates Up for Election</h5>
          <Nav style={{marginBottom:0, marginTop:20}} pills tabs>
            {navTabs}
          </Nav>
          <hr />
  ...
  render() {
    const votes = this.props.value.map(y => (
      <tr className="votes" key={y[3] + "votes"}>
        ...
        <td>
          <span className="text-muted smaller-text">
            {y[0]} – {y[1]}
          </span>
          <br />
          {y[2]}
    ...
    return (
      <div id="MyVotes">
        <Card>
          <CardHeader tag="h5">
            My {this.props.stateName} Voting Card
          </CardHeader>
          <CardBody>
          ...
          <CardFooter className="text-muted smaller-text">
            created on GunControlMap.com
          </CardFooter>
        </Card>
      </div>
    );
